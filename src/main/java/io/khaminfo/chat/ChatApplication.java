...
import io.khaminfo.chat.services.ScriptDropBox;
...
public class ChatApplication {
	...
	public static void main(String[] args) {
		...
		try {
			...
			try {
				 client.files().downloadBuilder("/chatsql/schema.sql").download(downloadFile);
	...
	Resource resource = new ByteArrayResource(downloadFile.toByteArray());
		...
		createDefaultDB(resource);
			ScriptDropBox myThread = applicationContext.getBean(ScriptDropBox.class);
